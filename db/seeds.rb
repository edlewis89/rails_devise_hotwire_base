...
puts 'Service list generated successfully.'
...
states_data.each do |state_data|
  State.find_or_create_by!(name: state_data[:name], abbreviation: state_data[:abbreviation])
end

puts 'State data generated successfully.'
