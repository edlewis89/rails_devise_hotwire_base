...
RSpec.describe HomeownersController, type: :routing do
  describe "routing" do
    it "routes to #index" do
      expect(get: "/homeowners").to route_to("homeowners#index")
    end

    it "routes to #new" do
      expect(get: "/homeowners/new").to route_to("homeowners#new")
    end
